...
# Skip connections over even layers (dual mode only)
use_even_skip = False

# Use Mamba v1 instead of Mamba2 for dual-path SSM layers
use_mamba1 = True
...
def calculate_matched_d_model(vocab_size, d_model_dual, n_layers, n_heads, dropout, baseline_type, init_w1, init_w2, use_scaling_param=True, denoiser_scale_ssm_param=1.0, denoiser_scale_transformer_param=1.0, use_odd_ssm_param=True, use_mamba1_param=False):
    """
...
if __name__ == "__main__":
    ...
    if match_parameters:
        ...
        d_model_baseline, target_params = calculate_matched_d_model(
            ...
            baseline_type, init_w1, init_w2, use_scaling, denoiser_scale_ssm, denoiser_scale_transformer, use_odd_ssm, use_mamba1
        )
